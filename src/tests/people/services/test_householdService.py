...
@mock.patch.object(HouseholdDAO, 'get_household_by_id')
def test_update_household(mock_get_household_by_id, mock_get_address_by_id, mock_get_person_by_id, mock_get_image_by_id,
    ...
    image_entity = media_models.Image(id=1, store="local", address="test.jpg")
    ...
    assert mock_get_image_by_id.call_count == 1
...
@mock.patch.object(AddressDAO, 'get_address_by_id')
@mock.patch.object(HouseholdDAO, 'get_household_by_id')
def test_update_household_no_image(mock_get_household_by_id, mock_get_address_by_id, mock_get_person_by_id, mock_get_image_by_id):
