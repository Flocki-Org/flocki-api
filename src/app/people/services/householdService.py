...
class HouseholdService:
    ...
    def add_household(self, household: CreateHousehold):
        ...
        image_entity = self.media_DAO.get_image_by_id(household.household_image.id)
    ...
    def upload_household_image(self, id, file):
        ...
        if file is not None:
            ...
            updated_household = self.household_DAO.get_household_by_id(id)
            return self.household_factory.createHouseholdFromHouseholdEntity(updated_household, True)
